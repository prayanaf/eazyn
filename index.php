        ...
        <div>
          ...
          >
            <a href="./index.php" class="text-nowrap logo-img">
              <img src="assets/images/logos/logo1.png" width="120" alt="" />
            </a>
            <div
            ...
            >
              ...
              >
                ...
                <li class="nav-item dropdown">
                  ...
                  >
                    <img
                      src="assets/images/profile/aku.jpg"
                      alt=""
                      width="35"
                      height="35"
                              ...
                              <div class="d-flex align-items-center gap-2">
                                <?php
                                  if($data["is_approved"] == 0){
                                    ...
                                    ?>
                                    <span class="badge bg-success rounded-3 fw-semibold">validasi bk</span>
                                    <?php
                                  }else {
                                    ?>
